...
print(np.shape(receve_list))

with open('/home/liu/Robotics-Aerial-Robots-HW-ws/src/Robotics_Aerial/Homework11/hw11/src/output.csv', 'w') as csvfile:
  writer = csv.writer(csvfile)
  writer.writerow(num_list)
  writer.writerow(receve_list)

with open('/home/liu/Robotics-Aerial-Robots-HW-ws/src/Robotics_Aerial/Homework11/hw11/src/data.csv', 'r') as csvfile:
  next(csvfile)
  reader = csv.reader(csvfile, quoting=csv.QUOTE_NONNUMERIC)
  for row in reader:
    kf_list = np.hstack((kf_list,row[3]))
  print(kf_list)
